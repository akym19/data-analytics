/*
	Script Purpose:
		Creates the table in the FloodControl silver schema
...
IF OBJECT_ID ('silver.flood_control_projects', 'U') IS NOT NULL
DROP TABLE silver.flood_control_projects;
GO

CREATE TABLE silver.flood_control_projects (
	ProjectID INT,
